                ...
                <div class="col-md-4 mx-auto revenue-chart">
                    <div class="card card-custom">
                        ...
                        <div class="mt-3 total-revenue-text">
                            <p class="mb-2"><span class="stat-label">Total Revenue</span> <span class="stat-value">$5,042</span></p>
                            <p class="mb-2"><span class="stat-label">Monthly Recurring Revenue</span> <span class="stat-value">$1,345</span></p>
                            <p class="mb-2"><span class="stat-label">Pro Plan Conversions</span> <span class="stat-value">47</span></p>
                            <p class="mb-0"><span class="stat-label">Transaction Value</span> <span class="stat-value">$219,900</span></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 platform-card">
                    ...
                    <div class="stats-card">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <h6>Coach Rating Distribution (4.3/5)</h6>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 completed">
                                ...
                                <div class="stats-value">13,289</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 leaderboard-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3 bates-add">
                        <div class="d-flex align-items-center">
                            <img src="/coach-backend/public/assets/imges/ellipse-one.png" class="coach-img me-2" alt="coach" />
                            <span class="coach-name">Jennifer Bates</span>
                        </div>
                        <span class="coach-value">$35,600</span>
                    </div>

                    <div class="d-flex align-items-center justify-content-between mb-3 bates-add">
                        <div class="d-flex align-items-center">
                            <img src="/coach-backend/public/assets/imges/ellipse-two.png" class="coach-img me-2" alt="coach" />
